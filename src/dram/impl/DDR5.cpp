...
class DDR5 : public IDRAM, public Implementation {
  ...
  private:
    ...
    void set_preqs() {
      ...
      m_preqs[m_levels["bank"]][m_commands["RDA"]] = Lambdas::Preq::Bank::RequireRowOpen<DDR5>;
      m_preqs[m_levels["bank"]][m_commands["WRA"]] = Lambdas::Preq::Bank::RequireRowOpen<DDR5>;
    };
    ...
    void set_rowhits() {
      ...
      m_rowhits[m_levels["bank"]][m_commands["RDA"]] = Lambdas::RowHit::Bank::RDWR<DDR5>;
      m_rowhits[m_levels["bank"]][m_commands["WRA"]] = Lambdas::RowHit::Bank::RDWR<DDR5>;
    }
    ...
    void set_rowopens() {
      ...
      m_rowopens[m_levels["bank"]][m_commands["RDA"]] = Lambdas::RowOpen::Bank::RDWR<DDR5>;
      m_rowopens[m_levels["bank"]][m_commands["WRA"]] = Lambdas::RowOpen::Bank::RDWR<DDR5>;
    }
